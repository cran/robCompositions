...
###################################################
### chunk number 5: new data
###################################################
x <- genData(100)


###################################################
### chunk number 6: plot.acomp
###################################################
plot.acomp <- 
...
###################################################
### chunk number 8: class
###################################################
class(xImp)


###################################################
### chunk number 9: printSummary
###################################################
methods(class = "imp")
xImp
...
### chunk number 10: imp
###################################################
impKNNa(x$zmiss, k=5, metric="Aitchison", normknn=TRUE)
...
###################################################
### chunk number 12: variations
###################################################
v1 <- robVariation(constSum(x$z2[1:95,]))
v2 <- robVariation(constSum(xImp1$xImp[1:95,]))
v22 <- robVariation(constSum(xImp2$xImp[1:95,]))
...
###################################################
### chunk number 13: erg-variations
###################################################
