...
%@
\includegraphics{imputation-plot-acomp}  
\vspace*{-33mm}
...
\begin{Schunk}
\begin{Soutput}
[1] "RDA: iterative lm approach: 0.529"
\end{Soutput}
\begin{Soutput}
[1] "RDA: iterative ltsReg approach: 0.307"
\end{Soutput}
\begin{Soutput}
[1] "DV: iterative lm approach: 0.052"
\end{Soutput}
\begin{Soutput}
[1] "DV: iterative ltsReg approach: 0.007"
\end{Soutput}
\end{Schunk}
...
%@
\includegraphics{imputation-boxplot}
\vspace*{-1cm}
\caption{Boxplot comparison of the estimated column-wise geometric means of
...
\begin{figure}[h]
\begin{center}
\includegraphics{imputation-plot1}
\vspace*{-0.4cm}
\caption{Multiple Scatterplot to highlight imputed observations.}
\label{repFig1b}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics{imputation-plot4}
\vspace*{-3mm}
\caption{Ternary diagram with special plotting symbols for highlighting imputed
